...
| `DATABASE\_URL`         | URL de conexão com o PostgreSQL |

| `DATABASE\_USERNAME`    | Usuário do banco                |

| `DATABASE\_PASSWORD`    | Senha do banco                  |

| `PORT`                 | Porta da API                    |

| `CORS\_ALLOWED\_ORIGINS` | Origens permitidas pelo CORS    |
...
$env:DATABASE\_URL="jdbc:postgresql://localhost:5432/servidores\_db"

$env:DATABASE\_USERNAME="servidores"

$env:DATABASE\_PASSWORD="servidores"

$env:PORT="8080"

$env:CORS\_ALLOWED\_ORIGINS="http://localhost:4200"
...
A origem permitida pode ser definida através da variável `CORS\_ALLOWED\_ORIGINS`.
